...
BTN_NEXTTUTORIAL		= NewMenuButton("m_btnNextTutorial",	"$5579",	"$5579",	0,	LAYOUT_BUTTONS,	nil,	"FE_NextTutorial()")
BTN_RESTARTTUTORIAL		= NewMenuButton("m_btnRestartTutorial",	"$5563",	"$5563",	0,	LAYOUT_BUTTONS,	nil,	"FE_RestartGame(1)")
