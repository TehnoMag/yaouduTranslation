...
----------------------- Title Text Row -----------------------			
		{
			...
			
			{
				...
				;
				{
					...
					;
					NewMenuButton("key01",	"$48555",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1",	[[UI_SetElementVisible('LaunchMenuRPGmissionM07','key01',0);]]),  --44681  ¹Ø±Õ			
					NewMenuButton("key03",	"$48630",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1",	[[UI_SetElementVisible('LaunchMenuRPGmissionM07','key03',0);]]),  --44681  ¹Ø±Õ	
					NewMenuButton("key05",	"$48725",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1",	[[UI_SetElementVisible('LaunchMenuRPGmissionM07','key05',0);]]),  --44681  ¹Ø±Õ	
				},
			},				
		},
	},
