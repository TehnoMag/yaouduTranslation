...
----------------------- Title Text Row -----------------------			
		{
			...
			
			{
				...
				;
				{
					...
					;
					NewMenuButton("key02",	"$48625",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1",	[[UI_SetElementVisible('LaunchMenuRPGmissionM15','key02',0);]]),  --44681  ¹Ø±Õ		
					NewMenuButton("key05",	"$48765",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1",	[[UI_SetElementVisible('LaunchMenuRPGmissionM15','key05',0);]]),  --44681  ¹Ø±Õ		
