...
----------------------- Title Text Row -----------------------			
		{
			...
			
			{
				...
				;
				{
					...
					;
					NewMenuButton("key01",	"$48555",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1",	[[UI_SetElementVisible('LaunchMenuRPGmissionM05','key01',0);]]),  --44681  ¹Ø±Õ			
					NewMenuButton("key05",	"$48715",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1",	[[UI_SetElementVisible('LaunchMenuRPGmissionM05','key05',0);]]),  --44681  ¹Ø±Õ			
				},
			},				
		},
	},
