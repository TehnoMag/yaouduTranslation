...
----------------------- Title Text Row -----------------------			
		{
			...
			
			{
				...
				;
				{
					...
					;
					NewMenuButton("key05",	"$48745",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1",	[[UI_SetElementVisible('LaunchMenuRPGmissionM33','key05',0);]]),  --44681  ¹Ø±Õ			
				},
			},				
		},
	},
