			...
			{ 
	            ...
	            --hAlign = "Center",
							...
							;
							{
								type = "Frame",
								Layout = {
									pox_XY = {x=0, y=0, xr="pair", yr="scr"},
									size_WH = {w = 1, h = .25, wr = "par", hr="scr",}
								},
								;
								{
									type = "Frame",
									Layout = {
										pos_XY = {x=0, y=0, xr="par", yr="scr",},
								...
								},
								{
									type = "TextLabel",
									Layout = {
										pos_XY = {x=0.07, y=0, xr="par", yr="par",},
								...
								},
								{
									type = "Frame",
									Layout = {
										pos_XY = {x=0.8, y=0, xr="par", yr="scr",},
										size_WH = { w = .06, h = .06, wr="par", hr="par", },
										pivot_XY = { x=.5, y=.5, xr="px", yr="px", },
										lockAspect=1,
									},
								...
								},
								{
									type = "TextLabel",
									Layout = {
										pos_XY = {x=0.87, y=0, xr="par", yr="par",},
										size_WH = { w=.2, h =.06, wr = "par", hr = "par",},
									},
									name = "SGDescFight",
									Text = {
							...
							},
							{
									...
									Layout = 
									{
										pos_XY = {x=5/1080, y=40/1920, xr="scr", yr="scr",},
										max_WH = { w=91/800, h = 600/450, wr = "scr", hr = "scr",},
										--pivot_XY = { -1, 0, },
									},
									name = "SGDesc",
...
function CreateBuyShipButton()
	local MouseEvent1 = "UI_SetElementVisible('TradeMenu','BuyShip',1) "
	local MouseEvent2 = "UI_SetElementVisible('TradeMenu','playercommand',1) "
	local BSBF = 
	{
	    	type = "Button",
	    	Layout = 
...
size_WH = { w=40/800, h = 22/450, wr = "scr", hr = "scr",},
	    	...
	    	DefaultGraphic = 
	    	{
					texture = "DATA:ui\\newui\\pvpimage\\buy_dflt.tga",
					uvRect = { 0,1,1,0 },
				},
					OverGraphic = 
				{
					texture = "DATA:ui\\newui\\pvpimage\\buy_pass.tga",
					uvRect = { 0,1,1,0 },
				},
				PressedGraphic = 
				{
					texture = "DATA:ui\\newui\\pvpimage\\buy_down.tga",
					uvRect = { 0,1,1,0 },
				},
				onMouseClicked = MouseEvent1..MouseEvent2,
				helpTip = "$5528",
				helpTipTextLabel = "TradeHelpTips"
	}
	return BSBF
end

function CreateSellShipButton()
	local MouseEvent1 = "UI_SetElementVisible('TradeMenu','SellShip',1) "
	local MouseEvent2 = "UI_SetElementVisible('TradeMenu','playercommand',1) "
	local BSBF = 
	{
	    	type = "Button",
...
size_WH = { w=40/800, h = 22/450, wr = "scr", hr = "scr",},
	    	...
	    	DefaultGraphic = 
	    	{
					texture = "DATA:ui\\newui\\pvpimage\\sell_dflt.tga",
					uvRect = { 0,1,1,0 },
				},
					OverGraphic = 
				{
					texture = "DATA:ui\\newui\\pvpimage\\sell_pass.tga",
					uvRect = { 0,1,1,0 },
				},
				PressedGraphic = 
				{
					texture = "DATA:ui\\newui\\pvpimage\\sell_down.tga",
					uvRect = { 0,1,1,0 },
				},
				onMouseClicked = MouseEvent1..MouseEvent2,
				helpTip = "$5529",
...
function CreateBuyGoodsButton()
	local MouseEvent1 = "UI_SetElementVisible('TradeMenu','BuyGoods',1) "
	local MouseEvent2 = "UI_SetElementVisible('TradeMenu','playercommand',1) "
	local BOBF = 
			{
	    	type = "Button",
...
function CreateBuyNumFrame()
	local MouseEvent1 = "UI_SetElementVisible('TradeMenu','BuyNum1',1) "
	local MouseEvent2 = "UI_SetElementVisible('TradeMenu','BuyNum2',1) "
	local MouseEvent3 = "UI_SetElementVisible('TradeMenu','playercommand',1) "
	local BNF = 
			{
	    	type = "Frame",
	    	Layout = 
...
function CreateSellGoodsButton()
	local MouseEvent1 = "UI_SetElementVisible('TradeMenu','SellGoods',1) "
	local MouseEvent2 = "UI_SetElementVisible('TradeMenu','playercommand',1) "
	local SOBF = 
	{
	    	type = "Button",
...
function CreateSellNumFrame()
	local MouseEvent1 = "UI_SetElementVisible('TradeMenu','SellNum1',1) "
	local MouseEvent2 = "UI_SetElementVisible('TradeMenu','SellNum2',1) "
	local MouseEvent3 = "UI_SetElementVisible('TradeMenu','playercommand',1) "
	local SNF = 
			{
	    	type = "Frame",
...
function CreateDELButton1()
	local MouseEvent1 = "UI_SetElementVisible('TradeMenu','NumDEL',1) "
	local MouseEvent2 = "UI_SetElementVisible('TradeMenu','playercommand',1) "
	local SOBF = 
	{
	    	type = "Button",
...
size_WH = { w=20/800, h = 22/450, wr = "scr", hr = "scr",},
	    	...
	    	DefaultGraphic = 
	    	{
					texture = "DATA:ui\\newui\\pvpimage\\DEL_dflt.tga",
					uvRect = { 0,1,1,0 },
				},
					OverGraphic = 
				{
					texture = "DATA:ui\\newui\\pvpimage\\DEL_pass.tga",
					uvRect = { 0,1,1,0 },
				},
				PressedGraphic = 
				{
					texture = "DATA:ui\\newui\\pvpimage\\DEL_down.tga",
					uvRect = { 0,1,1,0 },
				},
				onMouseClicked = MouseEvent1..MouseEvent2,
	}
...
function CreateACButton1()
	local MouseEvent1 = "UI_SetElementVisible('TradeMenu','NumAC',1) "
	local MouseEvent2 = "UI_SetElementVisible('TradeMenu','playercommand',1) "
	local SOBF = 
	{
	    	type = "Button",
...
size_WH = { w=20/800, h = 22/450, wr = "scr", hr = "scr",},
	    	...
	    	DefaultGraphic = 
	    	{
					texture = "DATA:ui\\newui\\pvpimage\\AC_dflt.tga",
					uvRect = { 0,1,1,0 },
				},
					OverGraphic = 
				{
					texture = "DATA:ui\\newui\\pvpimage\\AC_pass.tga",
					uvRect = { 0,1,1,0 },
				},
				PressedGraphic = 
				{
					texture = "DATA:ui\\newui\\pvpimage\\AC_down.tga",
					uvRect = { 0,1,1,0 },
				},
				onMouseClicked = MouseEvent1..MouseEvent2,
	}
...
function CreateMenuSwitchButton1()
	...
	local MouseEvent2 = "UI_SetElementVisible('TradeMenu','playercommand',1) "
	local MouseEvent3 = "UI_SetElementVisible('TradeMenu','SwitchToShip',0) "
	local MouseEvent4 = "UI_SetElementVisible('TradeMenu','ShipsMenu',1) "
	local MSBF = 
		{
    	type = "Button",
    	Layout = 
...
size_WH = { w=32/800, h = 28/450, wr = "scr", hr = "scr",},
    	...
    	DefaultGraphic = 
    	{
				texture = "DATA:ui\\newui\\pvpimage\\switchship_dflt.tga",
				uvRect = { 0,1,1,0 },
			},
				OverGraphic = 
			{
				texture = "DATA:ui\\newui\\pvpimage\\switchship_pass.tga",
				uvRect = { 0,1,1,0 },
			},
			PressedGraphic = 
			{
				texture = "DATA:ui\\newui\\pvpimage\\switchship_down.tga",
				uvRect = { 0,1,1,0 },
			},
			onMouseClicked = MouseEvent1..MouseEvent2..MouseEvent3..MouseEvent4,
			helpTip = "$5532",
			helpTipTextLabel = "TradeHelpTips"
		}
	return MSBF
...
function CreateMenuSwitchButton2()
	...
	local MouseEvent2 = "UI_SetElementVisible('TradeMenu','playercommand',1) "
	local MouseEvent3 = "UI_SetElementVisible('TradeMenu','SwitchToGood',0) "
	local MouseEvent4 = "UI_SetElementVisible('TradeMenu','GoodsMenu',1) "
	local MSBF = 
		{
    	type = "Button",
    	Layout = 
...
size_WH = { w=32/800, h = 28/450, wr = "scr", hr = "scr",},
    	...
    	DefaultGraphic = 
    	{
				texture = "DATA:ui\\newui\\pvpimage\\switchgood_dflt.tga",
				uvRect = { 0,1,1,0 },
			},
				OverGraphic = 
			{
				texture = "DATA:ui\\newui\\pvpimage\\switchgood_pass.tga",
				uvRect = { 0,1,1,0 },
			},
			PressedGraphic = 
			{
				texture = "DATA:ui\\newui\\pvpimage\\switchgood_down.tga",
				uvRect = { 0,1,1,0 },
			},
			onMouseClicked = MouseEvent1..MouseEvent2..MouseEvent3..MouseEvent4,
			helpTip = "$5532",
...
function CreateStationGoodsItem(Index)
    local MouseEvent1 = "iGoodsSelect2 = "..Index
    local MouseEvent2 = "UI_SetElementVisible('TradeMenu','NumClear',1) "
    local CHTT = 
	{
		type = "RadioButton",
	  	Layout = 
...
size_WH = { w=100/800, h = 30/450, wr = "scr", hr = "scr",},
			...
			texture = "DATA:ui\\newui\\pvpimage\\gooditem_dflt.tga",
			uvRect = { 0,1,1,0 },
		},
		OverGraphic = 
		{
...
size_WH = { w=100/800, h = 30/450, wr = "scr", hr = "scr",},
			...
			texture = "DATA:ui\\newui\\pvpimage\\gooditem_pass.tga",
			uvRect = { 0,1,1,0 },
		},
		PressedGraphic = 
		{
...
size_WH = { w=100/800, h = 30/450, wr = "scr", hr = "scr",},
			...
			texture = "DATA:ui\\newui\\pvpimage\\gooditem_down.tga",
			uvRect = { 0,1,1,0 },
		},
		onMouseClicked = MouseEvent1..MouseEvent2,
		;
...
size_WH = { w=100/800, h = 53/450, wr = "scr", hr = "scr",},
				...
				texture = "DATA:ui\\newui\\pvpimage\\shipitem_dflt.tga",
				uvRect = { 0,1,1,0 },
			},
				OverGraphic = 
			{
		  	Layout = 
				...
				texture = "DATA:ui\\newui\\pvpimage\\shipitem_pass.tga",
				uvRect = { 0,1,1,0 },
			},
			PressedGraphic = 
			{
		  	Layout = 
				...
				texture = "DATA:ui\\newui\\pvpimage\\shipitem_down.tga",
				uvRect = { 0,1,1,0 },
			},
...
pos_XY = {x=2/800, y=0/450, xr="scr", yr="scr",},
				...
				;
				CreateFactoryGraphicFrame(Index),  --使用帮助2：去掉"--"解锁舰船缩略图的显示(F3，后面还有)
				{ 
					type = "TextLabel", 
					Layout = 
					{
...
function CreateShipGoodsItem(Index)
    local MouseEvent1 = "iGoodsSelect1 = "..Index
    local MouseEvent2 = "UI_SetElementVisible('TradeMenu','NumClear',1) "
    local CHTT = 
	{
		type = "RadioButton",
    ...
    local CHTT = 
		{
		  ...
		  DefaultGraphic = 
		  {
			...
			;
			{
				...
				;
				CreateShipsGraphicFrame(Index),--使用帮助2：这里一样
				{ 
					type = "TextLabel", 
					Layout = 
					{
...
size_WH = { w=800/800, h = 450/450, wr = "scr", hr = "scr",},
	...
	[[
		...
		UI_SetElementVisible("TradeMenu","NumClear",1)
	]],
	onUpdate = 
	[[
--显示
...
--从商品界面退出
		...
		if (iShipSelect1~=iShipSelected1) then
			...
			if (shiplist[iShipSelect1]~=nil) then
				UI_SetElementVisible("TradeMenu","FS"..iShipSelect1.."Graph",1)
				UI_SetTextLabelText("TradeMenu","FSDesc",shiplist[iShipSelect1].Description)
				UI_SetTextLabelText("TradeMenu","FSName",shiplist[iShipSelect1].realname)
			else
				UI_SetElementVisible("TradeMenu","FF"..iShipSelect1.."Graph",1)
				UI_SetElementVisible("TradeMenu","playercommand",1)
				UI_SetTextLabelText("TradeMenu","FSName",Factory[iShipSelect1-DTM4_GetTableNum(shiplist)].Name)
			end
		...
		if (iShipSelect2~=iShipSelected2) then
			...
			if (shiplist[iShipSelect2]~=nil) then
				...
				UI_SetElementVisible("TradeMenu","playercommand",1)
				UI_SetTextLabelText("TradeMenu","SSName",Factory[iShipSelect2-DTM4_GetTableNum(shiplist)].Name)
			end
	...
	onHide = [[
							...
							if (shiplist[iShipClear1]~=nil) then
								...
								while (UI_IsNamedElementVisible("TradeMenu","FF"..iShipClear1.."Graph")==0)and(Factory[iShipClear1-DTM4_GetTableNum(shiplist)]~=nil) do
									iShipClear1 = iShipClear1 + 1
								end
							...
							if (shiplist[iShipClear2]~=nil) then
								...
								while (UI_IsNamedElementVisible("TradeMenu","SF"..iShipClear2.."Graph")==0)and(Factory[iShipClear2-DTM4_GetTableNum(shiplist)]~=nil) do
									iShipClear2 = iShipClear2 + 1
								end
								if (Factory[iShipClear2-DTM4_GetTableNum(shiplist)]~=nil) then
...
size_WH = { w=260/800, h = 400/450, wr = "scr", hr = "scr",},
	    ...
	    { 
	        type = "Graphic", 
	        texture = "Data:ui\\newui\\pvpimage\\shipmenuleft.tga", 
					uvRect = { 0,1,1,0 },
	    },
	    ;
	    CreateFleetShipList(),
...
size_WH = { w=85/800, h = 9/450, wr = "scr", hr = "scr",},
	  ...
	  --贸易站船只菜单
	    ...
	    { 
	        type = "Graphic", 
	        texture = "Data:ui\\newui\\pvpimage\\shipmenuright.tga", 
					uvRect = { 0,1,1,0 },
	    },
	    ; 
	    ...
	    CreateStationShipBigImage(),
	    	...
	    	DefaultGraphic = 
	    	{
					texture = "DATA:ui\\newui\\pvpimage\\exit_dflt.tga",
					uvRect = { 0,1,1,0 },
				},
					OverGraphic = 
				{
					texture = "DATA:ui\\newui\\pvpimage\\exit_pass.tga",
					uvRect = { 0,1,1,0 },
				},
				PressedGraphic = 
				{
					texture = "DATA:ui\\newui\\pvpimage\\exit_down.tga",
					uvRect = { 0,1,1,0 },
				},
				onMouseClicked = 
				[[
...
size_WH = { w=260/800, h = 400/450, wr = "scr", hr = "scr",},
	    ...
	    { 
	        type = "Graphic", 
	        texture = "Data:ui\\newui\\pvpimage\\goodmenuleft.tga", 
					uvRect = { 0,1,1,0 },
	    }, 
	    ;
	  ...
	  --贸易站货物菜单
	    ...
	    { 
	        type = "Graphic", 
	        texture = "Data:ui\\newui\\pvpimage\\goodmenuright.tga", 
					uvRect = { 0,1,1,0 },
	    },
	    ; 
	  ...
	  --舰队货物说明
		...
		CreateBlindFrame("NumAC"),
		CreateBlindFrame("NumDEL"),
		CreateBlindFrame("NumClear"),
		CreateBlindFrame("BuyNum1"),
		CreateBlindFrame("BuyNum2"),
		CreateBlindFrame("BuyGoods"),
		CreateBlindFrame("SellNum1"),
		CreateBlindFrame("SellNum2"),
		CreateBlindFrame("SellGoods"),
		CreateBlindFrame("BuyShip"),
		CreateBlindFrame("SellShip"),
		CreateBlindFrame("playercommand"),
